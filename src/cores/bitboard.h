...
inline void set_bit(Bitboard &b, Square s) { b |= (1ULL << s); }

inline void clear_bit(Bitboard &b, Square s) { b &= ~(1ULL << s); }

inline bool has_bit(Bitboard b, Square s) { return b & (1ULL << s); }
